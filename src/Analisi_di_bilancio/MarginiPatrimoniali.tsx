...
const rows = [["A", "B", "C", "D"],
  ...
  ["Indebitamento finanziario corrente netto (j) (i-e-d)", formatCurrency(vars.Margini_Patrimoniali_B14), "Debiti per Imposte (j)", formatCurrency(vars.Bilancio_B197+dataBilancio.B200)],
 ...
 posizione finanziaria netta (j+n)`, formatCurrency(- (vars.Margini_Patrimoniali_B14+vars.Margini_Patrimoniali_B18)), "Indebitamento netto (Posizione Netta) (d+g-l-s)", formatCurrency(vars.Margini_Patrimoniali_D25)],
  ...
  ["Debiti per Imposte (j)", formatCurrency(vars.Bilancio_B197+dataBilancio.B200), "Liquidità differita (g) (e+f)", formatCurrency(vars.Margini_Patrimoniali_D34)],
  ...
  ["", "", "Debiti per Imposte (j)", formatCurrency(vars.Bilancio_B197+dataBilancio.B200)],
